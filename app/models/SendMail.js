...
MailSchema.statics = {
  buyproduct: function (req,data, success, cb) {
      var self = this;
      var obj = {};
    //  console.log("===========================",email);
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
  <center>
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable">
      ...
      obj.subject = "KRYPTUAL products invoice!.";
      // obj.email = req.body.email;
      obj.email = 'kunwarsingh7595@gmail.com';
      self.send(obj,cb);
  },
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
  <center>
    ...
    registerMail: function (req, verifyurl, cb) {
        ...
        obj.email = req.email;
        // obj.email = 'abc@yopmail.com , def@yopmail.com';
        self.send(obj,cb);
    },
