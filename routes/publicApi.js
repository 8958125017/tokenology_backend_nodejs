...
var Maintenance = require('../app/controllers/MaintenanceCtrl.js');
...
/* To register a user. */
router.post('/createAddress',user.createAddress);
...
router.post('/getResellerCode',user.getResellerCode);
router.post('/getKryptualPoints', user.getKryptualPoints);

// website under maintence
router.post('/createWebsiteStatus',Maintenance.createWebsiteStatus);
router.post('/checkWebsiteStatus',Maintenance.checkWebsiteStatus);
router.post('/validateAddress',user.validateAddress);
